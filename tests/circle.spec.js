...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    expect(circle(2)).toHaveProperty('circumference',12.56); //referencia ---> https://jestjs.io/pt-BR/docs/expect#tohavepropertykeypath-value
    // Teste se dentro do objeto retornado, a função retorna uma key com value igual a área correta para um círculo de raio 3.
    expect(circle(3).area).toBeCloseTo(28.26, 4); //referencia ---> https://jestjs.io/pt-BR/docs/expect#tobeclosetonumber-numdigits
    // Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3.
    expect(circle(3)).toMatchObject({
      radius: 3, area: 28.259999999999998, circumference: 18.84
    }); //refencia ---> https://jestjs.io/pt-BR/docs/expect#tomatchobjectobject
  });
});
